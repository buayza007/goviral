  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        viral:
          "bg-gradient-to-r from-viral-500 to-viral-600 text-white hover:from-viral-600 hover:to-viral-700 shadow-lg shadow-viral-500/25 hover:shadow-xl hover:shadow-viral-500/40 hover:scale-[1.02]",
        ocean:
          "bg-gradient-to-r from-ocean-500 to-ocean-600 text-white hover:from-ocean-600 hover:to-ocean-700 shadow-lg shadow-ocean-500/25 hover:shadow-xl hover:shadow-ocean-500/40 hover:scale-[1.02]",
      },
      size: {
